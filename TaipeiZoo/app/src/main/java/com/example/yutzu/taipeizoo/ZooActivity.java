...
public class ZooActivity extends AppCompatActivity implements LifecycleOwner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zooViewModel = ViewModelProviders.of(this).get(ZooViewModel.class);
        zooViewModel.init(zone);
...
//            textView.setText(getString(R.string.section_format, getArguments().getInt(ARG_SECTION_NUMBER)));
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0: ZooFragment fragment = new ZooFragment();
                    return fragment;
                case 1: PlantListFragment fragment2 = new PlantListFragment();
//                    if(zooViewModel.getFragLayout()!=null){
